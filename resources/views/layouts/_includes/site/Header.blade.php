...
<head>
    ...
    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="/site/images/icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/site/images/icon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/site/images/icon.png">
