                ...
                <div class="row">
                    <div class="col">
                        <div class="home_content d-flex flex-row align-items-end justify-content-start">
                            <div class="current_page"><h2>Contactos</h2></div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact_form_container">
                        ...
                        @endif
                        <form method="post" action="{{ route('site.help.email') }}" class="contact_form"
                            id="contact_form">
                            @csrf
                            ...
                            <a href="#">
                                <div class="logo_container d-flex flex-row align-items-start justify-content-start">
                                    <div class="logo_image">
                                        <div>
                                            <img src="/site/images/logo.png" alt="meninas e as TIC" />
                                        </div>
                                    </div>
